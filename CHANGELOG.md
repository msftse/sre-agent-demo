...
- Added a manually dispatched `Start Stage 17 incident` workflow that creates a governed intentional-regression PR, waits for required validation, and merges only that setup PR automatically.
